          ...
          <header class="header ">
             <nav class="megamenu navbar navbar-default navbar-fixed-top"style="padding-bottom:25px;">             
                <div class="container">
                  ...
                  <div id="navbar" class="navbar-collapse collapse" style="padding-bottom:1S5px;">          
                      <ul class="nav navbar-nav" style="float:right;">
                        <li><a href="{{url('home')}}">ACCUEIL</a></li>
                        <li><a class="dropdown dropdown-toggle" data-toggle="dropdown" href="#">CERTIFICATION</a>
                        ...
                        <li><a href="{{url('actualite')}}">ACTUALITES</a></li>
             ...
             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <footer class=" row page-footer font-small blue-grey lighten-5" style="margin-top:150px; background-color:#4a4e50; color:white;">     
                   <div class="container"style="background-color: #21d192;">
                      <h6 class="mb-0">Vous pouvez nous contacter a tout moment !</h6>     
                   </div>
                   <!-- Footer Links -->
                   <div class=" row container text-center ">
                        <!-- Grid row -->
                        <div class="col-md-offset-3 col-lg-offset-3 col-xl-offset-3   col-md-10 col-lg-10 col-xl-10  ">
                              <!-- Grid column -->                                      
                              ...
                              <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mb-4">
                                  ...
                                  <hr class="teal accent-3 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
                                  <p> <a class="dark-grey-text" href="{{url('index')}}">Accueil</a> </p>
                                  <p> <a class="dark-grey-text" href="{{url('formation')}}">Formation</a> </p>
                                  <p> <a class="dark-grey-text" href="{{url('actualite')}}">Actualites</a></p>
                              ...
                              <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                                  ...
                                  <p> <i class="fas fa-envelope mr-3"></i> betetmechant@gmail.com</p>
